                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        ...
                        <div class="header-top-navigation">
                            <nav>
                                <ul>
                                    <li class="active"><router-link to="/p">home</router-link></li>
                                        ...
                                        <div class="message-dropdown" id="a">
                                            ...
                                            <ul class="dropdown-msg-list">
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="profile-thumb">
                                                        <figure class="profile-thumb-middle">
                                                            <img src="../assets/dashboard/images/profile/menu.png" alt="profile picture">
                                                        </figure>
                                                    </div>
                                                    <!-- profile picture end -->
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="profile-thumb">
                                                        <figure class="profile-thumb-middle">
                                                            <img :src="hostName + '../assets/dashboard/images/profile/profile-small-5.jpg'" alt="profile picture">
                                                        </figure>
                                                    </div>
                                                    <!-- profile picture end -->
                                        ...
                                        <div class="message-dropdown" id="b">
                                            ...
                                            <ul class="dropdown-msg-list">
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="profile-thumb">
                                                        <figure class="profile-thumb-middle">
                                                            <img :src="hostName + '../assets/dashboard/images/profile/profile-small-3.jpg'" alt="profile picture">
                                                        </figure>
                                                    </div>
                                                    <!-- profile picture end -->
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="profile-thumb">
                                                        <figure class="profile-thumb-middle">
                                                            <img :src="hostName + '../assets/dashboard/images/profile/profile-small-4.jpg'" alt="profile picture">
                                                        </figure>
                                                    </div>
                                                    <!-- profile picture end -->
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="profile-thumb">
                                                        <figure class="profile-thumb-middle">
                                                            <img :src="hostName + '../assets/dashboard/images/profile/profile-small-6.jpg'" alt="profile picture">
                                                        </figure>
                                                    </div>
                                                    <!-- profile picture end -->
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="brand-logo text-center">
                            <a href="index.html">
                                <img :src="hostName + '../assets/dashboard/images/logo/logo.png'" alt="brand logo">
                            </a>
                        </div>
                        <!-- brand logo end -->
                    </div>
                                ...
                                <div class="profile-thumb-small">
                                    ...
                                    <div class="profile-dropdown">
                                        <div class="profile-head">
                                            <h5 class="name"><router-link to="/p/profile">{{userData.names}}</router-link></h5>
                                           <router-link to="/p/profile" class="mail">{{userData.email}}</router-link>
                                        </div>
                                        <div class="profile-body">
                                            <ul>
                                                <li><router-link to="/p/profile"><i class="flaticon-user"></i>Profile</router-link></li>
                                                <li><a href="#"><i class="flaticon-message"></i>Inbox</a></li>
                                                <li><a href="#"><i class="flaticon-document"></i>Activity</a></li>
                                            </ul>
                                            <ul>
                                                <li><a href="#"><i class="flaticon-settings"></i>Setting</a></li>
                                                <li><a :href="hostName + '/logout'"><i class="flaticon-unlock"></i>Sign out</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="mobile-header-wrapper sticky d-block d-lg-none">
            <div class="mobile-header position-relative ">
                <div class="mobile-logo">
                    <a href="index.html">
                        <img :src="hostName + '../assets/dashboard/images/logo/logo.png'" alt="logo">
                    </a>
                </div>
                            ...
                            <ul class="frnd-request-list">
                                <li>
                                    <div class="frnd-request-member">
                                        <figure class="request-thumb">
                                            <a href="profile.html">
                                                <img :src="hostName + '../assets/dashboard/images/profile/profile-midle-1.jpg'" alt="proflie author">
                                            </a>
                                        </figure>
                                ...
                                <li>
                                    <div class="frnd-request-member">
                                        <figure class="request-thumb">
                                            <a href="profile.html">
                                                <img :src="hostName + '../assets/dashboard/images/profile/profile-midle-2.jpg'" alt="proflie author">
                                            </a>
                                        </figure>
                                        <div class="frnd-content">
                                            <h6 class="author"><a href="profile.html">merry watson</a></h6>
                                ...
                                <li>
                                    <div class="frnd-request-member">
                                        <figure class="request-thumb">
                                            <a href="profile.html">
                                                <img :src="hostName + '../assets/dashboard/images/profile/profile-midle-3.jpg'" alt="proflie author">
                                            </a>
                                        </figure>
                                        <div class="frnd-content">
                                            <h6 class="author"><a href="profile.html">merry watson</a></h6>
                            ...
                            <div class="mobile-chat-box">
                                <div class="live-chat-title">
                                    ...
                                    <div class="profile-thumb">
                                        <a href="profile.html">
                                            <figure class="profile-thumb-small profile-active">
                                                <img :src="hostName + '../assets/dashboard/images/profile/profile-35x35-13.jpg'" alt="profile picture">
                                            </figure>
                                        </a>
                                    </div>
                                    <!-- profile picture end -->
                                    ...
                                    <div class="live-chat-settings ml-auto">
                                        <button class="chat-settings"><img :src="hostName + '../assets/dashboard/images/icons/settings.png'" alt=""></button>
                                        <button class="close-btn"><img :src="hostName + '../assets/dashboard/images/icons/close.png'" alt=""></button>
                                    </div>
                                </div>
                                ...
                                <div class="chat-text-field mob-text-box">
                                    ...
                                    <button class="chat-message-send" type="submit" value="submit">
                                        <img :src="hostName + '../assets/dashboard/images/icons/plane.png'" alt="">
                                    </button>
                                </div>
                            </div>
                        </li>
                ...
                <div class="mobile-header-profile">
                    ...
                    <div class="profile-thumb profile-setting-box">
                        <a href="javascript:void(0)" class="profile-triger">
                            <figure class="profile-thumb-middle">
                                <img :src="hostName + '../assets/dashboard/images/profile/profile-small-1.jpg'" alt="profile picture">
                            </figure>
                        </a>
