                                        ...
                                        <ul>
                                            ...
                                            <li class="d-flex align-items-center profile-active">
                                                ...
                                                <div class="profile-thumb active">
                                                    <a href="#">
                                                        <figure class="profile-thumb-small">
                                                            <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-35x35-2.jpg'" alt="profile picture">
                                                        </figure>
                                                    </a>
                                                </div>
                                                <!-- profile picture end -->
                                            ...
                                            <li class="d-flex align-items-center profile-active">
                                                ...
                                                <div class="profile-thumb active">
                                                    <a href="#">
                                                        <figure class="profile-thumb-small">
                                                            <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-35x35-3.jpg'" alt="profile picture">
                                                        </figure>
                                                    </a>
                                                </div>
                                                <!-- profile picture end -->
                                    ...
                                    <div class="active-profile-carousel slick-row-20 slick-arrow-style">
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-35x35-11.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-35x35-12.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="live-chat-inner">
                                    <div class="chat-text-field">
                                        ...
                                        <button class="chat-message-send" type="submit" value="submit">
                                            <img s:src="'//' + serverName + '/assets/dashboard/images/icons/plane.png'" alt="">
                                        </button>
                                    </div>
                                    ...
                                    <div class="active-profile-mobile">
                                            ...
                                            <div class="profile-thumb active profile-active">
                                                <a href="#">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-1.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-8.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-2.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-3.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-4.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/profile/images/profile-small-5.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-slide">
                                            <div class="profile-thumb active profile-active">
                                                <a href="javascript:void(0)">
                                                    <figure class="profile-thumb-small profile-active">
                                                        <img :src="'//' + serverName + '/assets/dashboard/images/profile/profile-small-9.jpg'" alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        </div>
